    ...
    <header class="container-fluid">
            ...
            <section class="row row justify-content-between align-items-center">
                ...
                <article class="col-md-3 mt-2 mt-md-0 col-3 d-flex justify-content-start">
                    <a href="../../vista/TIENDA/index.html"><img src="../../assets/Imagenes/image.png" width="60" alt="Logo"></a>
                </article>
        ...
        <div class="container mt-4">
            <section class="d-flex justify-content-end mb-3">
                <article class="dropdown">
                    ...
                    <article class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="#">Menos relevantes</a>
                        <a class="dropdown-item" href="#">Mayor precio</a>
                        <a class="dropdown-item" href="#">Menor precio</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item dropdown-toggle" href="#" id="categoryDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Categorías
                        </a>
                        <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                            <a class="dropdown-item" href="#">Electrónica</a>
                            <a class="dropdown-item" href="#">Hogar y cocina</a>
                            <a class="dropdown-item" href="#">Moda y ropa</a>
                            <a class="dropdown-item" href="#">Juguetes y Juegos</a>
                            <a class="dropdown-item" href="#">Deportes</a>
                            <a class="dropdown-item" href="#">Salud y Belleza</a>
                            <a class="dropdown-item" href="#">Libros y medios</a>
            ...
            <section class="product-card d-flex" id="producto">
                <article class="mr-3">
                    <img src="../../assets/Imagenes/producto-imagen1.jpg" width="200" alt="Producto">
                </article>
                <article>
                    <h5>Nombre del producto</h5>
                    <p>Empresa del producto <span class="badge badge-primary"><i class="fas fa-check-circle"></i></span></p>
                    <h4>$ Precio</h4>
                    <p>Descripcion</p>
                </article>
            </section>
