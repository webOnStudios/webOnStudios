...
<body>
    ...
    <header class="container-fluid">
        ...
        <main class="container mt-5" id="producto">
            <section class="row justify-content-between">
                    ...
                    <div id="productCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="../../assets/Imagenes/producto-imagen1.jpg" alt="Primera imagen">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="../../assets/Imagenes/producto-imagen2.jpg" alt="Segunda imagen">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="../../assets/Imagenes/producto-imagen3.jpg" alt="Tercera imagen">
                            </div>
                        </div>
                ...
                <article class="col-md-6">
                    ...
                    <form>
                        ...
                        <button type="submit" class="btn btn-primary btn-block" id="comprar-boton">Comprar</button>
                    </form>
                    <div class="mt-4">
                        <h5>Descripción</h5>
                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Laudantium, minus! Accusantium pariatur quidem dignissimos repellat officiis quo magni. Non alias nostrum obcaecati quisquam rerum natus ullam quod delectus odio? Odio!</p>
                        <p id="talles"><strong>Colores:</strong> del tal al tal</p>
                        <p id="colores"><strong>Colores:</strong> Rojo, Fuxia o Azul</p>
                    </div>
                    <div class="mt-4">
