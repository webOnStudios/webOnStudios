...
<body>
    ...
    <div id="terminos">
        <p>INFORMACIÓN RELEVANTE <br> <br>
            En el presente documento (en adelante, el “Contrato”) se establecen los términos y condiciones de WebOn Studios, con domicilio en ejemplo, que serán de aplicación al acceso y uso por parte del Usuario de esta página web (el  “SIGTO”). Les rogamos lean atentamente el presente Contrato. 
            Al acceder, consultar o utilizar el Sitio Web, los Usuarios acepta cumplir los términos y condiciones establecidos en este Contrato. En caso de que usted no acepte quedar vinculado por los presentes términos y condiciones, no podrá acceder a, ni utilizar, el Sitio Web. 
            WebOn Studios y sus respectivas empresas afiliadas se reservan el derecho de actualizar el presente Contrato siempre que lo consideren oportuno. En consecuencia, recomendamos al Usuario revisar periódicamente las modificaciones efectuadas al Contrato.
            El presente Sitio Web está dirigido exclusivamente a personas residentes en Uruguay. Los Usuarios residentes o domiciliados en otro país que deseen acceder y utilizar el Sitio Web, lo harán bajo su propio riesgo y responsabilidad, por lo que deberán asegurarse de que dichos accesos y/o usos cumplen con la legislación aplicable en su país.
            ...
            Los menores no están autorizados para utilizar el Sitio Web. Si usted es menor de edad corre el riesgo de ser sancionado.
            ...
            El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. nohay.com no asume la responsabilidad en caso de que entregue dicha clave a terceros.
            ...
            <br>
            <br>
            WebOn Studios  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
            <br>
            <br>
            USO NO AUTORIZADO
            <br>
            ...
            <li>En condiciones de operación eléctrica acorde con las especificaciones y tolerancias indicadas.</li>
            </ul>
            <br>
            <br>
            ...
            <br>
            <br>
            Este nohay.com garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.
            WebOn Studios se reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
