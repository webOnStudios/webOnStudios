    ...
    <header class="container-fluid">
            ...
            <section class="row row justify-content-between align-items-center">
                ...
                <article class="col-md-3 mt-2 mt-md-0 col-3 d-flex justify-content-start">
                    <a href="../..vista/TIENDA/index.html"><img src="../../assets/Imagenes/image.png" alt="Logo Tiendas WebOn" width="60"></a>
                </article>
        ...
        <section class="container mt-5">
            <section class="row">
                <article class="col-md-3" id="barra-costado">
                    <h5 class="sidebar-title">Mi cuenta</h5>
                    <ul class="list-unstyled">
                        <li><a href="#">Panel de control de la cuenta</a></li>
                        <li><a href="#">Información de la cuenta</a></li>
                        <li><a href="#">Mis órdenes</a></li>
                        <li><a href="#">Devolución de Productos</a></li>
                    </ul>
                </article>
                <article class="col-md-9">
                    <h4 class="page-title">Cuenta</h4>
                    <p>Hola, Nombre Apellido!</p>
                    <p>Desde el panel de Tu Cuenta, tienes la habilidad de ver un listado de tu actividad reciente, así como también actualizar la información de tu cuenta. Selecciona un link aquí abajo para ver o editar tu información.</p>
                    <p><a href="#">Información de la cuenta</a></p>
                    <hr>
                    <h6>INFORMACION DE CONTACTO <a href="#" class="edit-link">Editar</a></h6>
                    <p>Nombre Apellido<br>correodeusuario@gmail.com<br><a href="#" class="edit-link">Cambiar contraseña</a></p>
                    <hr>
                    <h6>LIBRO DE DIRECCIONES</h6>
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Dirección de envío por defecto</h6>
