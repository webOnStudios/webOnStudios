    ...
    <header class="container-fluid">
            ...
            <section class="row row justify-content-between align-items-center">
                ...
                <article class="col-md-3 mt-2 mt-md-0 col-3 d-flex justify-content-start">
                    <a href="../../vista/TIENDA/index.html"><img src="../../assets/Imagenes/image.png" width="60" alt="Logo Tienda Webon"></a>
                </article>
            ...
            <section class="row">
                <article class="col-md-7">
                    <div class="card mb-3">
                        <section class="row no-gutters">
                            <article class="col-md-4">
                                <img src="../../assets/Imagenes/producto-imagen1.jpg" alt="Imagen Producto 1" class="img-responsive">
                            </article>
                    ...
                    <div class="card mb-3">
                        <section class="row no-gutters">
                            <article class="col-md-4">
                                <img src="../../assets/Imagenes/producto-imagen2.jpg" alt="Imagen Producto 2" class="img-responsive">
                            </article>
                            <article class="col-md-8">
                                <div class="card-body">
