...
<head>
 ...
 <body>
    ...
    <section class="container mt-4">
        ...
        <p class="text-center">Nos comunicaremos contigo via email para solucionar tu problema</p>
        <section class="row justify-content-center">
            <article class="col-md-6">
                    ...
                    <button type="submit" class="btn btn-danger" id="guardar">Enviar</button>
            </article>
        </section>
    </section>
    <script src="../../assets/JS/jquery-3.7.1.min.js"></script>
    <script src="../../assets/JS/EMPRESAS/ayuda-empresa.js"></script>
    <br>
