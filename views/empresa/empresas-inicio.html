 ...
 <body>
    ...
    <main class="container-fluid" id="barra-abajo">
        <section class="row justify-content-between align-items-center">
            ...
            <article class="col-md-6 mt-2 mt-md-0 col-12 d-flex justify-content-center">
                <a href="../../vista/EMPRESAS/registrarse-empresa.html"><button class="register-boton"><b>¡Registra tu empresa ya!</b></button></a>
            </article>
            <article class="col-md-1 mt-2 mt-md-0 col-12 d-flex justify-content-start">
    ...
    <section class="row justify-content-between align-items-center">
        <article class="col-md-12 col-12">
            <img src="../../assets/Imagenes/banner-empresa.jpg" class="banner">
        </article>
    </section>
